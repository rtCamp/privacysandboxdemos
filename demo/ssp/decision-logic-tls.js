...
function scoreAd(
  ...
  directFromSellerSignals,
	...
	console.groupCollapsed( "%c PAAPI SSP-TopLevelSeller %c scoreAd %c BID:%d => SCORE:%d", "color: green;  background-color:yellow; border: 1px solid black", "color: blue; border:1px solid black", "", bid, score);
...
function reportResult(auctionConfig, browserSignals, directFromSellerSignals) {
	console.groupEnd();
	console.groupCollapsed( "%c PAAPI SSP-TopLevelSeller %c reportResult %c BID:%d", "color: green;  background-color:yellow; border: 1px solid black", "color: blue; border:1px solid black", "", browserSignals.bid);
