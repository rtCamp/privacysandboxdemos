...
function generateBid(
  ...
  console.groupCollapsed( "%c PAAPI DSP2 %c generateBid %c IG:%s => BID:%d", "color: green;  background-color:orange; border: 1px solid black", "color: purple; border:1px solid black", "", interestGroup.name, bidCPM);
...
function reportWin(
  ...
  directFromSellerSignals
	...
	console.groupEnd();
	console.groupCollapsed( "%c PAAPI DSP2 %c reportWin %c IG:%s => BID:%d", "color: green;  background-color:orange; border: 1px solid black", "color: purple; border:1px solid black", "", browserSignals.interestGroupName, browserSignals.bid);
